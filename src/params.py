...
def get_default_params(model_name):
    ...
    if "vit" in model_name:
        return {"lr": 1.0e-3, "beta1": 0.9, "beta2": 0.98, "eps": 1.0e-6}
    else:
        return {"lr": 1.0e-3, "beta1": 0.9, "beta2": 0.999, "eps": 1.0e-8}
...
def parse_args(args):
    ...
    # MMAcc Selection Args
    parser.add_argument(
        "--select",
        default=False,
        action='store_true',
        help='Whether to select samples before loss backward.'
    )
    parser.add_argument(
        "--select-strategy",
        default='ours',
        type=str,
        help='Selection strategy to choose.'
    )
    parser.add_argument(
        "--select-rate",
        default=0.5,
        type=float,
        help='Selection rate setting.'
    )
    parser.add_argument(
        "--warmup-point",
        default=5,
    ...
    args.name = os.path.join(args.name, timestamp)
